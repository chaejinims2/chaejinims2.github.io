...
```
Wayside Camera Club — membership application

Contact
- Email: dan1068@market.com
- Address: 52 [Q1] Street, Peacetown

How he heard about the club
- from a [Q2]

What he wants from the club
- to enter competitions
- to [Q3] with other photographers

Membership
- type chosen: [Q4] membership (£30 per year)

Past photography competitions
- Competition 1 — theme: [Q5]
  - judges’ comment: picture was too ‘busy’ (composition)
- Competition 2 — theme: sunsets
  - had to photograph the [Q6] as well as the sun
  - judges said the [Q7] was wrong (took the photo too soon)
- Competition 3 — title: [Q8]
  - had to show some [Q9] in the scene
  - judges said the photo was too [Q10]
```
...
DAN: Well, I also like to socialise [Q3] with other photographers.
